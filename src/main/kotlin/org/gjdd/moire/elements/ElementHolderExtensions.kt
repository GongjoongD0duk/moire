...
public inline fun ElementHolder.addStartWatchingListener(crossinline block: (ServerPlayNetworkHandler) -> Unit): Unit =
    (this as ElementHolderExtensions).`moire$addStartWatchingListener` { block(it) }

public inline fun ElementHolder.addSetAttachmentListener(crossinline block: (HolderAttachment?) -> Unit): Unit =
